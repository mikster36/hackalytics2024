...
def query(url: str, features=None, **kwargs):
    if features:
        ...
        col_set = ('address', 'zip', 'county', 'lat', 'long', 'bed', 'bath', 'sqft', 'lot size', 'year built', 'amenities', 'annual assoc. fee:',
                   'annual taxes', 'schools', 'list price')
        df = pd.DataFrame(columns=['address', 'zip', 'county', 'lat', 'long', 'bed', 'bath', 'sqft', 'lot size', 'year built', 'amenities',
